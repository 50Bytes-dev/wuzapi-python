...
if TYPE_CHECKING:
    from ..models.get_group_list_response_200_data_groups_item_participants_item import (
        GetGroupListResponse200DataGroupsItemParticipantsItem,
    )


T = TypeVar("T", bound="GetGroupListResponse200DataGroupsItem")


@_attrs_define
class GetGroupListResponse200DataGroupsItem:
    """
    Attributes:
        ...
        participants (Union[Unset, list['GetGroupListResponse200DataGroupsItemParticipantsItem']]):
    ...
    participants: Union[Unset, list["GetGroupListResponse200DataGroupsItemParticipantsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for participants_item_data in _participants or []:
            participants_item = GetGroupListResponse200DataGroupsItemParticipantsItem.from_dict(participants_item_data)
        ...
        get_group_list_response_200_data_groups_item = cls(
        ...
        get_group_list_response_200_data_groups_item.additional_properties = d
        return get_group_list_response_200_data_groups_item
