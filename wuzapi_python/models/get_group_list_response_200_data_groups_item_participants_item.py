...
T = TypeVar("T", bound="GetGroupListResponse200DataGroupsItemParticipantsItem")


@_attrs_define
class GetGroupListResponse200DataGroupsItemParticipantsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_group_list_response_200_data_groups_item_participants_item = cls(
            is_admin=is_admin,
            is_super_admin=is_super_admin,
            jid=jid,
        )

        get_group_list_response_200_data_groups_item_participants_item.additional_properties = d
        return get_group_list_response_200_data_groups_item_participants_item
