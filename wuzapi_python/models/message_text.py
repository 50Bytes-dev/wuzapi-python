...
if TYPE_CHECKING:
    from ..models.message_text_context_info import MessageTextContextInfo


T = TypeVar("T", bound="MessageText")
...
class MessageText:
    ...
    Attributes:
        ...
        context_info (Union[Unset, MessageTextContextInfo]):
    """

    phone: str
    body: str
    id: Union[Unset, str] = UNSET
    context_info: Union[Unset, "MessageTextContextInfo"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_context_info, Unset):
            ...
            context_info = MessageTextContextInfo.from_dict(_context_info)
        ...
        message_text.additional_properties = d
        return message_text
