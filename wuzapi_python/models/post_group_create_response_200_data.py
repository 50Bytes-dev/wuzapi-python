...
if TYPE_CHECKING:
    from ..models.post_group_create_response_200_data_participants_item import (
        PostGroupCreateResponse200DataParticipantsItem,
    )


T = TypeVar("T", bound="PostGroupCreateResponse200Data")


@_attrs_define
class PostGroupCreateResponse200Data:
    """
    Attributes:
        announce_version_id (Union[Unset, str]):  Example: 1234567890.
        disappearing_timer (Union[Unset, int]):
        group_created (Union[Unset, str]):  Example: 2023-12-01T10:00:00Z.
        is_announce (Union[Unset, bool]):
        is_ephemeral (Union[Unset, bool]):
        is_locked (Union[Unset, bool]):
        jid (Union[Unset, str]):  Example: 120363123456789@g.us.
        name (Union[Unset, str]):  Example: My New Group.
        name_set_at (Union[Unset, str]):  Example: 2023-12-01T10:00:00Z.
        ...
        participant_version_id (Union[Unset, str]):  Example: 1234567890.
        participants (Union[Unset, list['PostGroupCreateResponse200DataParticipantsItem']]):
    """
    ...
    participants: Union[Unset, list["PostGroupCreateResponse200DataParticipantsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for participants_item_data in _participants or []:
            participants_item = PostGroupCreateResponse200DataParticipantsItem.from_dict(participants_item_data)

            participants.append(participants_item)

        post_group_create_response_200_data = cls(
        ...
        post_group_create_response_200_data.additional_properties = d
        return post_group_create_response_200_data
