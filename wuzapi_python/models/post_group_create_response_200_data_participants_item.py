...
T = TypeVar("T", bound="PostGroupCreateResponse200DataParticipantsItem")


@_attrs_define
class PostGroupCreateResponse200DataParticipantsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_group_create_response_200_data_participants_item = cls(
            is_admin=is_admin,
            is_super_admin=is_super_admin,
            jid=jid,
        )

        post_group_create_response_200_data_participants_item.additional_properties = d
        return post_group_create_response_200_data_participants_item
