...
T = TypeVar("T", bound="PutWebhookResponse200Data")


@_attrs_define
class PutWebhookResponse200Data:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_webhook_response_200_data = cls(
            webhook_url=webhook_url,
            events=events,
            active=active,
        )

        put_webhook_response_200_data.additional_properties = d
        return put_webhook_response_200_data
