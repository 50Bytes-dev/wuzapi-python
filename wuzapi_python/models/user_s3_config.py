...
T = TypeVar("T", bound="UserS3Config")
...
class UserS3Config:
    ...
    Attributes:
        ...
        path_style (Union[Unset, bool]):  Example: True.
        public_url (Union[Unset, str]):  Example: https://s3.amazonaws.com.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_s3_config.additional_properties = d
        return user_s3_config
